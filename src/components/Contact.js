...
export const Contact = () => {
    ...
    return (
        ...
        <div className="col-md-6 col-sm-12 justify-content-center text-center">
         <a target="_blank"   rel="noreferrer" href="https://www.linkedin.com/in/sebastianmosquera/" className="linka"><button class="botoncito w-75 my-5">Linkedin</button></a>
        
        <a target="_blank"  rel="noreferrer" href="https://github.com/z4myk" className="linka"><button class="botoncito w-75 my-5">Github</button></a> 
